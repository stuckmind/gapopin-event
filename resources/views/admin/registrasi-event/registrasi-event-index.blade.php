...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <h2 class="text-2xl font-bold text-gray-800">Registrasi Event</h2>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                class="flex items-center justify-center gap-2 py-2 px-4 bg-blue-700 text-white hover:opacity-80 rounded-lg" title="Registrasi">
