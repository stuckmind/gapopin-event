    ...
    <div class="max-w-4xl mx-auto px-6">
        ...
        <div class="bg-white shadow-lg rounded-xl p-8">
            ...
            <form action="{{ route('event.register', $event->slug) }}" method="POST" class="space-y-4">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="optik" id="optik"
                            ...
                            placeholder="Masukkan Nama Optik" autocomplete="off" value="{{ old('optik') }}">
                    </div>
                    @error('optik')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" name="phone" id="phone" 
                            ...
                            placeholder="Masukkan Nomor Whatsapp" autocomplete="off" value="{{ old('phone') }}">
                    </div>
                    @error('phone')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <!-- Alamat Lengkap -->
                <div class="relative">
                    <label for="address" class="block text-gray-700 font-semibold mb-1">Alamat Lengkap</label>
                    <div class="relative">
                        ...
                        <textarea name="address" id="address" rows="3"
                            ...
                            placeholder="Masukkan Alamat Lengkap" autocomplete="off">{{ old('address') }}</textarea>
                    </div>
                    @error('address')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
